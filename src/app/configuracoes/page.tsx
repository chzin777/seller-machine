...
import { Sun, Moon, UserCog, Lock, Mail, User } from "lucide-react";
  ...
  return (
    <div className="max-w-2xl mx-auto py-10 px-4">
      ...
      <Card className="shadow-lg border border-gray-100 dark:border-gray-900 bg-white dark:bg-gray-950 mb-8">
        <CardHeader>
          <CardTitle className="text-lg font-bold flex items-center gap-2">
            <Mail className="w-5 h-5 text-blue-700 dark:text-blue-200" /> E-mail
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col gap-2">
            <Button className="w-fit hover:cursor-pointer bg-blue-100 text-blue-700 hover:bg-blue-200 dark:bg-blue-700 dark:text-white dark:hover:bg-blue-800 border-none shadow font-semibold px-5 py-2 rounded-lg" onClick={() => setShowEmailModal(true)}>Alterar e-mail</Button>
      ...
      <Card className="shadow-lg border border-gray-100 dark:border-gray-900 bg-white dark:bg-gray-950 mb-8">
        <CardHeader>
          <CardTitle className="text-lg font-bold flex items-center gap-2">
            <User className="w-5 h-5 text-blue-700 dark:text-blue-200" /> Dados pessoais
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col gap-2">
            <Button className="w-fit hover:cursor-pointer bg-blue-100 text-blue-700 hover:bg-blue-200 dark:bg-blue-700 dark:text-white dark:hover:bg-blue-800 border-none shadow font-semibold px-5 py-2 rounded-lg" onClick={() => setShowDadosModal(true)}>Alterar nome e sobrenome</Button>
      ...
      <Card className="shadow-lg border border-gray-100 dark:border-gray-900 bg-white dark:bg-gray-950">
        <CardHeader>
          <CardTitle className="text-lg font-bold flex items-center gap-2">
            <Lock className="w-5 h-5 text-blue-700 dark:text-blue-200" /> Segurança
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col gap-2">
            <Button className="w-fit hover:cursor-pointer bg-blue-100 text-blue-700 hover:bg-blue-200 dark:bg-blue-700 dark:text-white dark:hover:bg-blue-800 border-none shadow font-semibold px-5 py-2 rounded-lg" onClick={() => setShowSenhaModal(true)}>Alterar senha</Button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6 w-full max-w-sm relative">
            ...
            <div className="flex flex-col gap-3">
              ...
              />
              <Button onClick={handleAlterarEmail} disabled={loadingEmail} className="mt-2 hover:cursor-pointer bg-blue-100 text-blue-700 hover:bg-blue-200 dark:bg-blue-700 dark:text-white dark:hover:bg-blue-800 border-none shadow font-semibold px-5 py-2 rounded-lg">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6 w-full max-w-sm relative">
            ...
            <div className="flex flex-col gap-3">
              ...
              <input
                ...
                disabled={loadingDados}
              />
              <Button onClick={handleAlterarDados} disabled={loadingDados} className="mt-2 hover:cursor-pointer bg-blue-100 text-blue-700 hover:bg-blue-200 dark:bg-blue-700 dark:text-white dark:hover:bg-blue-800 border-none shadow font-semibold px-5 py-2 rounded-lg">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6 w-full max-w-sm relative">
            ...
            <div className="flex flex-col gap-3">
              ...
              <input
                ...
                disabled={loadingSenha}
              />
              <Button onClick={handleAlterarSenha} disabled={loadingSenha} className="mt-2 hover:cursor-pointer bg-blue-100 text-blue-700 hover:bg-blue-200 dark:bg-blue-700 dark:text-white dark:hover:bg-blue-800 border-none shadow font-semibold px-5 py-2 rounded-lg">
