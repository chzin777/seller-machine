  ...
  return (
    <div className="max-w-2xl w-full mx-auto py-8 px-2 sm:py-12 sm:px-4 flex flex-col">
      ...
      <form className="space-y-4">
        <textarea id="feedback-texto" className="w-full min-h-[120px] p-3 border-2 border-blue-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-blue-50 placeholder-blue-400 resize-y sm:resize-none" placeholder="Digite seu feedback aqui..." />
