...
export default function LoginPage() {
      ...
      <div className="relative z-10 w-full max-w-md mx-auto bg-white/90 dark:bg-gray-900/90 rounded-xl shadow-2xl p-8 flex flex-col items-center backdrop-blur-md">
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-5">
          <div className="flex flex-col gap-2">
            <label className="text-blue-800 dark:text-blue-200 font-semibold flex items-center gap-2">
              Email
            </label>
            <input
              type="email"
  ...
  <div className="absolute bottom-2 w-full text-center text-xs text-blue-200 z-10 select-none">Designed by Christofer</div>
    </div>
  );
}
